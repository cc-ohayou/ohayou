...
public class SuperTest
{
    ...
    public static SuperTest t1=new SuperTest("t1");
    //首先执行主方法 new对象之前要先把SuperTest中的静态属性初始化好
    public static SuperTest t2=new SuperTest("t2");
    //k=0;初始化 先静态后非静态 先属性后方法 t1属性先声明后赋值
    public static int i=print("i");
    //先声明属性 k=0 T1=NULL;t2=null i=0 n=0 再赋值 k=0 t1=new SuperTest("t1") 开始new对象
    public static int n=99;
    //值得注意****对象创建只针对非静态属性和方法 静态的属性和方法都由类自身在new之前初始化
    private int a=0;
    //因此开始对t1赋值 首先找到a=0 j=print("j")调用print方法打印 1:j i=0 n=0 然后i n自增1 往下执行构造块
    public int j=print("j");
    //print("构造块") 第二次调用print方法 打印 2:构造块 i=1 n=1 然后执行构造方法 打印 3:t1 i=2 n=2 至此t1赋值完毕
